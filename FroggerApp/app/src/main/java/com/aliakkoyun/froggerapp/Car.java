...
public class Car {
    ...
    Car(Resources res) {
        car1 = BitmapFactory.decodeResource(res, R.drawable.car1);
        car2 = BitmapFactory.decodeResource(res, R.drawable.car2);
        car3 = BitmapFactory.decodeResource(res, R.drawable.car3);
